...
const en = {
  translation: {
    ...
    cloud_login: "Log in to cloud",
    cloud_logout: "Log out",
    cloud_password: "Password",
    cloud_login_failed: "Wrong password",
    cloud_too_many_attempts: "Too many attempts, try again later",
    cloud_unavailable: "Cloud backend is not reachable",
    cloud_use_local_only: "Continue without cloud",
    cloud_session_expired: "Cloud session expired — log in again",
    cloud_status_synced: "Synced",
    cloud_status_pending: "{{count}} to sync",
    cloud_status_offline: "Offline",
    cloud_status_conflict: "Sync conflict",
    cloud_conflict_title: "Sync conflict",
    cloud_conflict_desc:
      "“{{name}}” was changed elsewhere at {{time}}. Which version do you want to keep? The losing version is kept in the cloud revision history.",
    ...
    tool_select: "Select",
    tool_table: "Table",
    tool_relationship: "Relationship",
    tool_note: "Note",
    tool_area: "Area",
    add_type: "Add type",
    inspector_summary: "{{fields}} fields · {{indices}} indices · {{relationships}} relations",
    basic_info: "Basic info",
    table_name: "Table name",
    table_alias: "Display name",
    field_name: "Field name",
    constraints: "Constraints",
    referenced_table: "References table",
    referenced_field: "References field",
    fields: "Fields",
    color: "Color",
    table: "Table",
    ...
    note: "Note",
    back_to_lists: "Back to all",
    nothing_selected: "Nothing selected",
    nothing_selected_text: "Pick a table, relationship, area or note on the canvas to edit it here.",
    tables: "Tables",
